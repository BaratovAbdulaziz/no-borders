...
from ..utils.config import SETUP_WIDTH, SETUP_HEIGHT, APP_NAME, APP_VERSION
...
class ControlPanel:
    ...
    def __init__(self, kvm_instance: 'KVMSwitch') -> None:
        ...
        self.hotkey_display: Optional[tk.Label] = None
    ...
    def _create_ui(self) -> None:
        ...
        # Start button
        self._create_start_button(main_container, mode_var, control_var)
    ...
    def _create_header(self, parent: tk.Frame) -> None:
        ...
        tk.Label(header, text=f"⚡ {APP_NAME}", font=("Arial", 28, "bold"),
                bg="#0f0f0f", fg="white").pack()
        tk.Label(header, text="Setup Your Connection", font=("Arial", 12),
                bg="#0f0f0f", fg="#6b7280").pack(pady=(5, 0))
    
    def _create_mode_selection(self, parent: tk.Frame, mode_var: tk.StringVar) -> None:
    ...
    def _create_control_method(self, parent: tk.Frame, control_var: tk.StringVar) -> None:
    ...
    def _create_hotkey_config(self, parent: tk.Frame) -> None:
    ...
    def _create_start_button(self, parent: tk.Frame, mode_var: tk.StringVar, control_var: tk.StringVar) -> None:
        """Create start button"""
    ...
    def _create_footer(self, parent: tk.Frame) -> None:
        ...
        tk.Label(btn_frame, text=f"v{APP_VERSION} • MIT License", font=("Arial", 9),
    ...
    def _record_hotkey_thread(self) -> None:
        ...
        # Use a listener that doesn't return False
